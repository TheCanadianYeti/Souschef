        ...
        <div className="flex justify-between h-16 items-center">
          <div className="flex items-center gap-2">
            <Link href="/" className="flex items-center gap-2 group">
              ...
              <div className="p-2 bg-brick rounded-xl text-page group-hover:scale-105 transition-transform duration-300">
                <ChefHat size={24} />
              </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/profile" className="focus:outline-none focus:ring-2 focus:ring-aged-gold rounded-full transition-transform hover:scale-105">
              {mounted && profileImage ? (
                ...
                <div className="h-8 w-8 rounded-full bg-gradient-to-tr from-brick to-aged-gold shadow-sm border-2 border-parchment-deep" />
              )}
            </Link>
          </div>
        </div>
